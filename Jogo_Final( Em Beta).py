...
def loopjogo():
    ...
    while gameExit == False:
        ...
        if aux_andar:
            if crack_y >= 480:      #definindo a ordem dos sprites do personagem
                vel_pulo = 0
                if aux == 0:
                    x = C_1    
                elif aux == 3:
        ...
        gameDisplay.blit(fundo, (y_fundo,posi_y))
 
       
        craquinho.append(gameDisplay.blit(x,(crack_x,crack_y)))
        ...
        if crack_y<480:  #o executador da gravidade do pulo do personagem
            vel_pulo -=1
            x = C_6
        print(trajetoria_objeto)
...
#        gerador_texto(str(placar), black, y_displace = -30, size="small")
        
        if slide:
            if crack_y + 47 == random_objeto_pos_y:
                if trajetoria_objeto == crack_x + 154:
                    gameOver = True
            
                
        else:        
            if crack_y == random_objeto_pos_y:
                if trajetoria_objeto == crack_x + 126:
                    gameOver = True
            if crack_y + 47 == random_objeto_pos_y:
                if trajetoria_objeto == crack_x + 126:
                    gameOver = True
